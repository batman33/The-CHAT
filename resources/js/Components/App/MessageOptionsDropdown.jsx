...
import { EllipsisVerticalIcon, LockClosedIcon, LockOpenIcon, ShieldCheckIcon, TrashIcon, UserIcon } from "@heroicons/react/24/solid/index.js";
...
const MessageOptionsDropdown = ({ message }) => {
  ...
  const onMessageDelete = () => {
    axios.delete(route("message.destroy", message.id)).then(({ data }) => {
      console.log(data);
      emit('message.deleted', { message, prevMessage: data });
    });
  };
  ...
  return (
    <div className="absolute right-full text-gray-100 top-1/2 -translate-y-1/2 z-10">
      <Menu as="div" className="relative inline-block text-left">
        ...
        >
          <Menu.Items className="absolute -left-4 mt-2 w-48 rounded-md bg-gray-800 shadow-lg z-50">
