...
import { ArrowDownTrayIcon, PlayCircleIcon } from "@heroicons/react/24/solid/index.js";
        ...
        <div className="mt-2 flex flex-wrap justify-end gap-1">
          {attachments.map((attachment, index) => (
            <div
              ...
              key={attachment.id}
              className={`group flex flex-col items-center justify-center text-gray-500 relative cursor-pointer ${isAudio(attachment) ? 'w-84' : 'w-32' +
                ' aspect-square bg-blue-100'}`}
            >
              {!isAudio(attachment) && (
                <a
              ...
              {isImage(attachment) && (
                <img src={attachment.url} alt={attachment.name} className="object-contain aspect-square" />
              )}
